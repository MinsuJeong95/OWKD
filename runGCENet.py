...
def run(args, models):
    for datasetType in args.datasetTypes:
        for Fold in args.Folds:
            ...
            GCENetValidation.validation(datasetType, Fold, args.modelTypes, modelType, models, gceNet, valDBPath,
                                         numOfClass, splitChannel=splitChannel)
            GCENetValidationAcc.accCalculate(datasetType, modelType, Fold)
            GCENetTest.test(datasetType, Fold, args.modelTypes, modelType, models, gceNet, testDBPath, numOfClass,
